 ...
 * form-filler that blindly populates every <input> it finds — or a
 * browser's autofill/password manager offering to fill "helpful" looking
 * fields — will still catch on `name="admin_pass"` / `root_token`.
 *
 * Usage: drop <CanweFields /> anywhere inside a <form>, then before calling
 * your real login logic in onSubmit, call checkCanweFields(e.target, ...)
 * from ../../utils/canweGuard.
 */
const CanweFields = () => (
  <div
    aria-hidden="true"
