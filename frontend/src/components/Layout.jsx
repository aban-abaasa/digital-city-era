...
const Layout = ({ children }) => {
  ...
  const customerNavigation = [
    { name: 'Customer Home', href: '/customer', icon: FiUser },
    { name: 'Customer Dashboard', href: '/customer-dashboard', icon: FiUsers },
    { name: 'Customer Login', href: '/customer-login', icon: FiHome },
  ];
      ...
      <div className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col">
        <div className="flex flex-col flex-grow bg-white border-r border-gray-200">
          ...
          <nav className="flex-1 space-y-1 px-2 py-4">
            ...
            <div className="pt-4 mt-4 border-t border-gray-200">
              <div className="px-2 py-1">
                <h3 className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Customer Hub</h3>
              </div>
              {customerNavigation.map((item) => {
                const isActive = location.pathname === item.href;
                return (
