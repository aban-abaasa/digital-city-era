 ...
 * this app has no custom-ringtone service).
 */
const IncomingCallOverlay = ({ call, onAccept, onDecline }) => {
  if (call.callState !== 'ringing-in') return null;

  return (
    <div className="fixed inset-0 z-[2000] flex flex-col items-center justify-between overflow-hidden bg-gradient-to-b from-cyan-700 via-blue-800 to-slate-900 px-6 py-10 text-white">
      ...
      <div className="flex w-full max-w-xs items-center justify-between">
        ...
        <div className="flex flex-col items-center gap-2">
          <button
            ...
            title="Accept"
          >
            {call.isVideo ? <FiVideo className="h-7 w-7" /> : <FiPhone className="h-7 w-7" />}
          </button>
