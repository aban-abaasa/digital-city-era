 ...
 * cross-app id this app has no resolver for, like ICAN's r2:// avatar keys —
 * detected and skipped rather than left broken). onError also falls back to
 * initials, so a deleted/expired image never leaves a blank hole in the
 * message list.
 */
export function ChatAvatar({ id, name, url, size = 'h-7 w-7 text-[10px]' }) {
