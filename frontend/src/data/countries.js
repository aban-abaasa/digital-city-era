// Shared country list, ported from mybodaguy's countries.ts. Display-name
// strings are kept identical across apps (e.g. 'Uganda') since this same
// list backs country pickers in mybodaguy and is stored as plain text.
