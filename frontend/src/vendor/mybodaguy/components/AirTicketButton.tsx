// Ported from mybodaguy's src/mybodaguy/components/AirTicketButton.tsx (same
// behaviour; the journey API is the shared mybodaguy backend).
 ...
 * booking, after a reload, or weeks later.
 */
  ...
  return (
    <div className="space-y-1.5">
      <button
        ...
        onClick={download}
        disabled={busy}
        className={className || 'inline-flex min-h-[40px] items-center gap-2 rounded-lg bg-orange-500 px-4 text-sm font-semibold text-white hover:bg-orange-600 disabled:opacity-60'}
      >
