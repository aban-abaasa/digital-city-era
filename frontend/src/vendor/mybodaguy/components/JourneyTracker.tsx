// Ported from mybodaguy's src/mybodaguy/components/JourneyTracker.tsx — the
// customer's My Journeys list: live legs, driver, air ticket download, and a
// refund notice when money was taken for a booking that did not complete.
