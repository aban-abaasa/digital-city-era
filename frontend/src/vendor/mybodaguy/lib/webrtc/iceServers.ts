/**
 * Shared ICE server list for the vendored mybodaguy call surface
 * (CallController.tsx). Ported from ICAN's lib/webrtc/iceServers.js — kept
 * self-contained inside vendor/mybodaguy rather than reaching into the host
 * app's own src/lib, matching how this subtree already vendors its own
 * services/supabaseClient instead of depending on the host app's.
 *
