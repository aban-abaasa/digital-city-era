 ...
 *
 * Ported from mybodaguy's src/services/featureAnalyticsService.ts. Swapped
 * `process.env.NODE_ENV` (undefined in a Vite browser bundle, since Vite
 * doesn't polyfill Node's `process`) for `import.meta.env.DEV`.
 */
