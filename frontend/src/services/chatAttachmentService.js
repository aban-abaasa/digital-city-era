...
// Mirrors bookingService.js's uploadBookingAttachment — a public Storage
// bucket, uploaded to straight from the browser, no backend involved. Used
// by the support ChatWidget (chat_messages) and the Community board/live
// chat (landing_messages) — both tables, and this bucket, are shared across
